...
/**
 *
 * Based off this clock, converted to React. 
 * https://www.w3schools.com/graphics/canvas_clock_start.asp
 * @param {*} props
 */
function Clock(props) {
  const { id, width = 300, height = 300, staticClock = false, hour = 0, minute = 0 } = props;
  ...
  return (
    <canvas ref={canvas} id={id} width={width} height={height} className="clock" ></canvas>
  );
}
